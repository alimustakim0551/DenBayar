...
const securityFeatures = [
  {
    ...
    desc: 'AES-256 encryption protects all data at rest and in transit, ensuring your financial information remains impenetrable.',
  ...
  },
  {
    ...
    desc: 'Multi-factor authentication with biometric verification adds an unbreakable layer of security to your account.',
  ...
  },
  {
    ...
    desc: 'All communications and transactions are encrypted end-to-end, making interception impossible.',
  ...
  },
  {
    ...
    desc: 'Hardware security modules (HSM) manage cryptographic keys with zero-knowledge architecture.',
  ...
  },
  {
    ...
    desc: 'AI-powered monitoring detects and neutralizes threats in real-time, 24/7 automated surveillance.',
  ...
  },
  {
    ...
    desc: 'Zero-knowledge proofs and data minimization ensure your personal information stays private.',
  ...
  return (
    <div ref={containerRef} className="min-h-screen landing-gradient text-white overflow-x-hidden">
      ...
      <section id="security" className="relative py-24 z-10">
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-100px' }} className="text-center mb-16">
            <motion.span variants={fadeUp} custom={0} className="inline-block px-4 py-1.5 rounded-full bg-emerald-500/10 text-sm font-medium text-emerald-400 mb-4 border border-emerald-500/20">
              <ShieldCheck className="h-3 w-3 inline mr-1" /> Advanced Security
            </motion.span>
            <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-5xl font-bold mb-4">
              <span className="gradient-text">Fortified Protection</span>
            </motion.h2>
            <motion.p variants={fadeUp} custom={2} className="text-white/50 text-lg max-w-2xl mx-auto">
              Six layers of enterprise-grade security ensure your funds and data remain impenetrable.
            </motion.p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {securityFeatures.map((feature, i) => (
              <motion.div
                ...
                variants={scaleIn}
                custom={i}
                className={`glass-card rounded-2xl p-8 relative overflow-hidden group shadow-xl ${feature.glow}`}
              >
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <motion.h2 variants={fadeUp} custom={0} className="text-3xl md:text-4xl font-bold mb-6">
                  Your funds are <span className="gradient-text-gold">protected</span> with military-grade security
                </motion.h2>
                <motion.p variants={fadeUp} custom={1} className="text-white/50 leading-relaxed mb-8">
                ...
                <motion.div variants={fadeUp} custom={2} className="space-y-3">
                  {[
                    ...
                    'AI-powered threat detection & monitoring',
              ...
              >
                <div className="relative">
                  <motion.div
                    ...
                    className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-br from-purple-600/20 to-amber-500/20 flex items-center justify-center glow-purple"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute -top-4 -right-4 glass rounded-xl p-3 glow-orange"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-4 -left-4 glass rounded-xl p-3 glow-purple"
                  >
